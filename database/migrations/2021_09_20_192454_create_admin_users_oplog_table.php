...
class CreateAdminUsersOplogTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection($this->connection)->create('admin_users_oplog', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::connection($this->connection)->dropIfExists('admin_users_oplog');
    }
}
