...
class CreateAgentsLoginTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection($this->connection)->create('agents_login_log', function (Blueprint $table) {
            $table->Increments('id');
    ...
    {
        Schema::connection($this->connection)->dropIfExists('agents_login_log');
    }
}
