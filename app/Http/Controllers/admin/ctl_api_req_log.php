...
class ctl_api_req_log extends Controller
{
    ...
    public function __construct(repo_api_req_log $repo_api_req_log)
    {
        parent::__construct();
    ...
    public function index(Request $request)
    {
        ...
        $page_size  = $request->input('page_size', $this->repo_api_req_log->page_size);
        ...
        $rows = $this->repo_api_req_log->get_list($conds);
    ...
    public function delete(Request $request)
    {
        ...
        $status = $this->repo_api_req_log->del(['id' => $id]);
        if($status < 0)
        {
            return res_error($this->repo_api_req_log->get_err_msg($status), $status);
        }
