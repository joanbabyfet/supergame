...
use App\Models\mod_member_balance_data;
use App\traits\trait_repo_base;

class repo_member_balance_data
{
    use trait_repo_base;
    ...
    public function __construct(mod_member_balance_data $mod_member_balance_data)
    {
        $this->model = $mod_member_balance_data;
    }
