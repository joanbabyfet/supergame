...
class repo_member_online_per_hour
{
    use trait_repo_base;
    ...
    public function __construct(mod_member_online_per_hour $mod_member_online_per_hour)
    {
        $this->model = $mod_member_online_per_hour;
    }
