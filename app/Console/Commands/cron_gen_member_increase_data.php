...
class cron_gen_member_increase_data extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'member_increase_data:gen {from_date?}'; //参数加?表选填
     ...
     * @var string
     */
    protected $description = '生成會員增长数据';
     ...
     * @return void
     */
    public function __construct(serv_member_increase_data $serv_member_increase_data)
    {
        parent::__construct();
    ...
    public function handle()
    {
        ...
        $this->serv_member_increase_data->generate_data($from_date);
