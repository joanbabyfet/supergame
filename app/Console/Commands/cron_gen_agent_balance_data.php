...
class cron_gen_agent_balance_data extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'agent_balance_data:gen {from_date?}'; //参数加?表选填
     ...
     * @var string
     */
    protected $description = '生成渠道代理额度统计记录';
     ...
     * @return void
     */
    public function __construct(serv_agent_balance_data $serv_agent_balance_data)
    {
        parent::__construct();
    ...
    public function handle()
    {
        ...
        $this->serv_agent_balance_data->generate_data($from_date);
